...
This guide will help you create your own Seller agent in the Agent Swarms ecosystem using this template.
...
For testing and deployment instructions please review the
template README.md

# TODO tell about README.md changes
