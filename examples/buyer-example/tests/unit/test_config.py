...
def test_settings_has_expected_fields():
    ...
    assert hasattr(settings, "search_engine_base_url")
    assert isinstance(settings.search_engine_base_url, str)

    assert hasattr(settings, "search_engine_timeout_seconds")
    assert isinstance(settings.search_engine_timeout_seconds, int)
...
def test_settings_timeouts_positive():
    ...
    assert settings.search_engine_timeout_seconds > 0
