"""
This module will stay as is for most servers, unless you need to customize how x402 payments are enforced or how headers and errors are handled.
...
from seller_template.config import PaymentOption, X402Config, get_x402_settings
