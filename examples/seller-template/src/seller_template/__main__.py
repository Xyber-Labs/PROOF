...
from seller_template.config import get_app_settings
from seller_template.logging_config import get_logging_config
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run the Seller Template Server.")
    ...
    uvicorn.run(
        "seller_template.app:create_app",
        host=args.host,
        port=args.port,
        reload=args.reload,
